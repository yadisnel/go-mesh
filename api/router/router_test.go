...
import (
	...
	"github.com/yadisnel/go-ms/v2/api/handler/rpc"
	"github.com/yadisnel/go-ms/v2/api/router"
	rregistry "github.com/yadisnel/go-ms/v2/api/router/registry"
	rstatic "github.com/yadisnel/go-ms/v2/api/router/static"
