...
import (
	...
	"github.com/yadisnel/go-ms/v1/api/handler/rpc"
	"github.com/yadisnel/go-ms/v1/api/router"
	rregistry "github.com/yadisnel/go-ms/v1/api/router/registry"
	rstatic "github.com/yadisnel/go-ms/v1/api/router/static"
