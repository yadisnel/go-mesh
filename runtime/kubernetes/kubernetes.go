// Package kubernetes implements kubernetes ms runtime
package kubernetes
...
// getService queries kubernetes for ms service
...
func (k *kubernetes) getService(labels map[string]string, opts ...client.GetOption) ([]*service, error) {
	...
	for _, kservice := range serviceList.Items {
		...
		srv.Service.Metadata["type"] = kservice.Metadata.Labels["ms"]
...
func (k *kubernetes) Delete(s *runtime.Service, opts ...runtime.DeleteOption) error {
	...
	// create new kubernetes ms service
...
func NewRuntime(opts ...runtime.Option) runtime.Runtime {
	// get default options
	options := runtime.Options{
		// Create labels with type "ms": "service"
		Type: "service",
	}
