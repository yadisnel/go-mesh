...
go-ms is a framework for distributed systems development. Its source code is based on the popular [go-micro](https://github.com/asim/nitro) (now Nitro) library.
