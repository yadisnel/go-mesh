...
go-ms is a framework for distributed systems development. Its source code is based on the popular [Nitro](https://github.com/asim/nitro) (formerly known as Go Micro) library.
